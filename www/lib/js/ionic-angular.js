        ...
        .factory('$collectionRepeatManager', [
            ...
            function ($rootScope, $timeout) {
                ...
                CollectionRepeatManager.prototype = {
                     ...
                     */
                    renderScroll       : ionic.animationFrameThrottle(function (transformLeft,
                                                                                transformTop,
                                                                                zoom,
                                                                                wasResize) {
                        if (this.isVertical) {
                ...
                viewContentLoaded = $scope.$on('$viewContentLoaded', function (e, historyData) {
                    ...
                    if (viewId) {
                        $timeout(function () {
                            ...
                            backListenDone = $rootScope.$on('$viewHistory.viewBack', function (e,
                                                                                               fromViewId,
                                                                                               toViewId) {
